...
public class FatBlaster {
	...
	private void initialize() {
		...
		JMenu myfile = new JMenu("File"); // file menubar
		menuBar.add(myfile);
		JMenuItem exit = new JMenuItem("Exit");
		exit.addActionListener((ActionListener) new forExit());
		myfile.add(exit);

		JMenu myProfile = new JMenu("Profile"); // profile menubar
		menuBar.add(myProfile);
		JMenuItem createProfile = new JMenuItem("Create");
		myProfile.add(createProfile);
		JMenuItem editProfile = new JMenuItem("Edit");
		myProfile.add(editProfile);		
		JMenuItem loadProfile = new JMenuItem("Load");
		myProfile.add(loadProfile);

		JMenu myView = new JMenu("View"); // view menubar
		menuBar.add(myView);

		JMenuItem calculationExcel = new JMenuItem("Calculations Excel");

		calculationExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {

				try {
					Desktop.getDesktop().open(new File("C:/Users/Public/Documents/CalculationExceloutput.xls"));
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
					try {
						WritableWorkbook workbook = Workbook.createWorkbook(new File("C:/Users/Public/Documents/CalculationExceloutput.xls"));
		...
		myView.add(calculationExcel);		

		JMenuItem foodDiaryExcel = new JMenuItem("Food Diary Excel");
		foodDiaryExcel.addActionListener(new ActionListener(){

			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				try {
					Desktop.getDesktop().open(new File("C:/Users/Public/Documents/FoodDiaryExceloutput.xls"));
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
					try {
						WritableWorkbook workbook = Workbook.createWorkbook(new File("C:/Users/Public/Documents/FoodDiaryExceloutput.xls"));
						/*WritableSheet sheet = workbook.createSheet("First Sheet", 0);
						jxl.write.Label label = new jxl.write.Label(0, 2, "A label record"); 
						sheet.addCell(label); 
